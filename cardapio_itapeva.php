...
<body id="body_empresa">
	...
	<div id="cardapio" class="banner_cardapio_itapeva">
    	&nbsp;
    </div>
    ...
    <div id="cont">
       ...
       -->
    	<div id="lanches_ita" class="cardapio" style="margin-top:335px;">
            <div class="titulos">Lanches:</div>
            
            <div id="lanches1_ita" style="margin-top: 40px">
            	<div class="n3_ita">1</div>
                <div class="descricao_lanches_ita">
                	<span>Dog Primo’s</span><br />
                    <div class="descricao_lanche_ita">(Pão, maionese, tomate, batata palha e salsicha)</div>
                    <div class="preco_lanche_ita" style="margin-top: -50px;"> 
            ...
            <div id="lanches1_ita" style="margin-top: 40px">
            	<div class="n3_ita">7</div>
                <div class="descricao_lanches_ita">
                	<span>Egg Bacon Primo's</span><br />
                    <div class="descricao_lanche_ita">(Pão, maionese, alface americana, tomate, cebola, molho especial, bacon, ovo, hambúrguere queijo prato)</div>
                    <div class="preco_lanche_ita" style="margin-top: -70px;"> 
                    	<span style="font-size:12px">R$</span>9,20                    	
                    </div>
                </div>
            </div>   
            
            <div id="lanches1_ita">
            	<div class="n3_ita">2</div>
                <div class="descricao_lanches_ita">
                	<span>Burger Primo’s</span><br />
                    <div class="descricao_lanche_ita">(Pão, maionese, hambúrguer e queijo prato)</div>
                    <div class="preco_lanche_ita" style="margin-top: -50px;"> 
                    	<span style="font-size:12px">R$</span>5,20                    	
                    </div>
                </div>
            </div>
            
            <div id="lanches1_ita">
            	<div class="n3_ita">8</div>
                <div class="descricao_lanches_ita">
                	<span>Double Primo’s</span><br />
                    <div class="descricao_lanche_ita">(Pão, maionese, alface americana, tomate, cebola, molho especial, dois hambúrgueres e queijo cheddar)</div>
                    <div class="preco_lanche_ita" style="margin-top: -70px;"> 
            ...
            <div id="lanches1_ita">
            	<div class="n3_ita">3</div>
                <div class="descricao_lanches_ita">
                	<span>Burger Salada</span><br />
                    <div class="descricao_lanche_ita">(Pão, maionese, alface americana, tomate, molho especial, hambúrguer e queijo prato)</div>
                    <div class="preco_lanche_ita" style="margin-top: -70px;"> 
                    	<span style="font-size:12px">R$</span>6,50                    	
                    </div>
                </div>
            </div>
            
            <div id="lanches1_ita">
            	<div class="n3_ita">9</div>
                <div class="descricao_lanches_ita">
                	<span>Tropical Primo’s</span><br />
                    <div class="descricao_lanche_ita">(Pão, maionese, cebola, peito de frango desfiado, requeijão cremoso e queijo prato)</div>
                    <div class="preco_lanche_ita" style="margin-top: -70px;"> 
            ...
            <div id="lanches1_ita">
            	<div class="n3_ita">4</div>
                <div class="descricao_lanches_ita">
                	<span>Bacon Júnior</span><br />
                    <div class="descricao_lanche_ita">( Pão, maionese, bacon e queijo)</div>
                    <div class="preco_lanche_ita" style="margin-top: -50px;">                  	
                    	<span style="font-size:12px">R$</span>5,20                   	
                    </div>
                </div>
            ...
            <div id="lanches1_ita">
            	<div class="n3_ita">10</div>
                <div class="descricao_lanches_ita">
                	<span>Chicken Primo’s</span><br />
                    <div class="descricao_lanche_ita">(Pão, maionese, alface americana, tomate, molho especial, peito de frango desfiado e queijo prato)</div>
                    <div class="preco_lanche_ita" style="margin-top: -70px;"> 
                    	<span style="font-size:12px">R$</span>7,50                    	
                    </div>
                </div>
            ...
            <div id="lanches1_ita">
            	<div class="n3_ita">5</div>
                <div class="descricao_lanches_ita">
                	<span>Bacon Primo's</span><br />
                    <div class="descricao_lanche_ita">(Pão, maionese, alface americana, tomate, cebola, molho especial, bacon, hambúrguer e queijo prato)</div>
                    <div class="preco_lanche_ita" style="margin-top: -70px;"> 
            ...
            <div id="lanches1_ita">
            	<div class="n3_ita">11</div>
                <div class="descricao_lanches_ita">
                	<span>Chicken Bacon Primo’s</span><br />
                    <div class="descricao_lanche_ita">(Pão, maionese, alface americana, tomate,molho especial, bacon, peito de frango desfiado e queijo prato)</div>
                    <div class="preco_lanche_ita" style="margin-top: -90px;"> 
                    	<span style="font-size:12px">R$</span>9,50                    	
                    </div>
                </div>
            </div>               
            ...
            <div id="lanches1_ita">
            	<div class="n3_ita">6</div>
                <div class="descricao_lanches_ita">
                	<span>Big Burger Primo’s </span><br />
                    <div class="descricao_lanche_ita">(Pão, maionese, alface americana, tomate, cebola, molho especial, hambúrguer, queijo prato e queijo cheddar)</div>
                    <div class="preco_lanche_ita" style="margin-top: -90px;"> 
                    	<span style="font-size:12px;">R$</span>7,90                    	
                    </div>
                </div>
            ...
            <div id="lanches1_ita">
            	<div class="n3_ita">12</div>
                <div class="descricao_lanches_ita">
                	<span>Primo’s Tudo</span><br />
                    <div class="descricao_lanche_ita">(Pão, maionese, alface americana, tomate, molho especial, bacon, ovo, salsicha, requeijão cremoso, peito de frango, desfiado e queijo prato)</div>
                    <div class="preco_lanche_ita" style="margin-top: -90px;"> 
                    	<span style="font-size:12px">R$</span>15,90                 	
                    </div>
                </div>
    	...
    	<div id="adicional_extra" class="cardapio">
            ...
            R$ 2,00<br /><!-- Hambúrguer -->
            R$ 2,00<br /><!-- Frango -->
            R$ 2,20<br /><!-- Bacon -->
            R$ 1,20<br /><!-- Salsicha -->
            R$ 1,20<br /><!-- Queijo cheddar -->
            R$ 1,20		 <!-- Queijo requeijão (cremoso) -->
            </div>
            ...
            R$ 1,20<br /><!-- Queijo prato -->
            R$ 1,00<br /><!-- Ovo -->
            R$ 0,90<br /><!-- Tomate -->
            R$ 0,90<br /><!-- Alface Americana -->
            R$ 0,90<br /><!-- Batata palha -->
            R$ 0,90		 <!-- Cebola -->
            </div>            
        </div>                
